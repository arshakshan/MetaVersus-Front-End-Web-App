...
<section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.div
        ...
        className="relative mt-[68px] flex w-full sm:h-[550px]"
      >
        <img 
          src="/map.png"
          alt="map"
        ...
        <div
          className="absolute sm:bottom-5 bottom-20 right-20 w-[70px] h-[70px] p-[6px] rounded-full bg-[#5d6680] object-contain"
        > 
          <img 
            src="/people-01.png"
            alt="people"
